...
C_1    = spatial_to_spin.one_electron(C_1, "blocked")
H_1_MO = spatial_to_spin.one_electron(H_1_MO, "blocked")
V_1_MO = spatial_to_spin.two_electron(V_1_MO, "blocked")
S_2    = spatial_to_spin.one_electron(S_2, "blocked")
H_2    = spatial_to_spin.one_electron(H_2, "blocked")
V_2    = spatial_to_spin.two_electron(V_2, "blocked")
C_2    = spatial_to_spin.one_electron(C_2, "blocked")
H_2_MO = spatial_to_spin.one_electron(H_2_MO, "blocked")
V_2_MO = spatial_to_spin.two_electron(V_2_MO, "blocked")

# Dump to disk
numpy.save(    "integrals/Be_C.npy", C_1)
numpy.save(    "integrals/Be_h.npy", H_1_MO)
numpy.save(    "integrals/Be_V.npy", V_1_MO)
numpy.save("integrals/Be2_{}_S.npy".format(sys.argv[1]), S_2)
numpy.save("integrals/Be2_{}_h_AO.npy".format(sys.argv[1]), H_2)
numpy.save("integrals/Be2_{}_V_AO.npy".format(sys.argv[1]), V_2)
numpy.save("integrals/Be2_{}_C.npy".format(sys.argv[1]), C_2)
numpy.save("integrals/Be2_{}_h.npy".format(sys.argv[1]), H_2_MO)
numpy.save("integrals/Be2_{}_V.npy".format(sys.argv[1]), V_2_MO)
