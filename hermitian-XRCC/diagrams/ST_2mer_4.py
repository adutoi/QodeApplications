...
def s01s01s10s10t00(X, contract_last=False):
    ...
    return (1/4) * raw(
        ...
        #@ X.s10(z,a)
        #@ X.t00(p,q)
          X.cccaaa0pXXXXq_Tpq(i0,j0,t,v,a,y)
...
def s01s01s01s10t10(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/6) * (-1)**(X.n_j0) * raw(
        ...
        #@ X.s10(z,a)
        #@ X.t10(p,q)
          X.cccaa0XXXXq_T1q(i0,j0,t,v,x,a,p)
...
def s01s01s10s10t01(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/4) * (-1)**(X.n_j0) * raw(
        ...
        #@ X.s10(z,a)
        #@ X.t01(p,q)
          X.cccaa0pXXXX_Tp1(i0,j0,t,v,a,y,q)
...
def s01s01s01s10t00(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return -(1/6) * raw(
        ...
        #@ X.s10(z,a)
        #@ X.t00(p,q)
          X.ccccaa0pXXXXq_Tpq(i0,j0,t,v,x,a)
...
def s01s01s01s10t11(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return -(1/6) * raw(
        ...
        @ X.ccaaaa1pXXXXq_Tpq(i1,j1,z,y,w,u)
        @ X.s01(v,w)
        @ X.s01(x,y)
        @ X.s10(z,a)
        )

def s01s01s01s01t10(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/24) * (-1)**(X.n_j0 + 1) * raw(
        ...
        #@ X.s01(z,a)
        #@ X.t10(p,q)
          X.cccca0XXXXq_T1q(i0,j0,t,v,x,z,p)
...
def s01s01s01s10t01(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/6) * (-1)**(X.n_j0 + 1) * raw(
        ...
        #@ X.s10(z,a)
        #@ X.t01(p,q)
          X.cccca0pXXXX_Tp1(i0,j0,t,v,x,a,q)
...
def s01s01s01s01t00(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/24) * raw(
        ...
        #@ X.s01(z,a)
        #@ X.t00(p,q)
          X.ccccca0pXXXXq_Tpq(i0,j0,t,v,x,z)
...
def s01s01s01s01t11(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/24) * raw(
        ...
        @ X.caaaaa1pXXXXq_Tpq(i1,j1,a,y,w,u)
        @ X.s01(v,w)
        @ X.s01(x,y)
        @ X.s01(z,a)
        )

def s01s01s01s01t01(X, contract_last=False):
    if no_result(X, contract_last):  return []
    i0, i1, j0, j1 = state_indices(contract_last)    # = 0, 1, 2, 3
    return (1/24) * (-1)**(X.n_j0) * raw(
        ...
        #@ X.s01(z,a)
        #@ X.t01(p,q)
          X.ccccc0pXXXX_Tp1(i0,j0,t,v,x,z,q)
