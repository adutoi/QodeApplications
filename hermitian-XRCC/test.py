...
if True:
    ...
    SH = {}
    #
    SH[6]   = XR_term.dimer_matrix(St_blocks_symm, active_St_diagrams, (0,1), dimer_charges[6])
    SH[6]  += XR_term.dimer_matrix(Su_blocks_symm, active_Su_diagrams, (0,1), dimer_charges[6])
    SH[6]  += XR_term.dimer_matrix(Sv_blocks_symm, active_Sv_diagrams, (0,1), dimer_charges[6])
    #
    SH[7]   = XR_term.dimer_matrix(St_blocks_symm, active_St_diagrams, (0,1), dimer_charges[7])
    SH[7]  += XR_term.dimer_matrix(Su_blocks_symm, active_Su_diagrams, (0,1), dimer_charges[7])
    SH[7]  += XR_term.dimer_matrix(Sv_blocks_symm, active_Sv_diagrams, (0,1), dimer_charges[7])
    #
    SH[8]   = XR_term.dimer_matrix(St_blocks_symm, active_St_diagrams, (0,1), dimer_charges[8])
    SH[8]  += XR_term.dimer_matrix(Su_blocks_symm, active_Su_diagrams, (0,1), dimer_charges[8])
    SH[8]  += XR_term.dimer_matrix(Sv_blocks_symm, active_Sv_diagrams, (0,1), dimer_charges[8])
    #
    SH[9]   = XR_term.dimer_matrix(St_blocks_symm, active_St_diagrams, (0,1), dimer_charges[9])
    SH[9]  += XR_term.dimer_matrix(Su_blocks_symm, active_Su_diagrams, (0,1), dimer_charges[9])
    SH[9]  += XR_term.dimer_matrix(Sv_blocks_symm, active_Sv_diagrams, (0,1), dimer_charges[9])
    #
    SH[10]  = XR_term.dimer_matrix(St_blocks_symm, active_St_diagrams, (0,1), dimer_charges[10])
    SH[10] += XR_term.dimer_matrix(Su_blocks_symm, active_Su_diagrams, (0,1), dimer_charges[10])
    SH[10] += XR_term.dimer_matrix(Sv_blocks_symm, active_Sv_diagrams, (0,1), dimer_charges[10])
