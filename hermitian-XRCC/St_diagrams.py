...
def t00(X, i0s,j0s):
    ...
    for i0 in range(i0s):
        for j0 in range(j0s):
            result[i0,j0] = 1 * scalar_value( X.ca0pq_Tpq[i0,j0] )
    return result
...
def t01(X, i0s,i1s,j0s,j1s):
    ...
    for i0 in range(i0s):
        for i1 in range(i1s):
            for j0 in range(j0s):
                for j1 in range(j1s):
                    result[i0,i1,j0,j1] = (-1)**(X.n_i1 + X.P) * scalar_value( X.c0[i0,j0](p) @ X.a1q_T0q[i1,j1](p) )
    return result
...
def s01t10(X, i0s,i1s,j0s,j1s):
    ...
    for i0 in range(i0s):
        for i1 in range(i1s):
            for j0 in range(j0s):
                for j1 in range(j1s):
                    result[i0,i1,j0,j1] = -1 * scalar_value( X.ca0tX_St1[i0,j0](q,u) @ X.ca1pX_Tp0[i1,j1](u,q) )
    return result
...
def s01t00(X, i0s,i1s,j0s,j1s):
    ...
    for i0 in range(i0s):
        for i1 in range(i1s):
            for j0 in range(j0s):
                for j1 in range(j1s):
                    result[i0,i1,j0,j1] = (-1)**(X.n_i1 + X.P + 1) * scalar_value( X.a1u_S0u[i1,j1](t) @ X.cca0pXq_Tpq[i0,j0](t) )
    return result
...
def s01t11(X, i0s,i1s,j0s,j1s):
    ...
    for i0 in range(i0s):
        for i1 in range(i1s):
            for j0 in range(j0s):
                for j1 in range(j1s):
                    result[i0,i1,j0,j1] = (-1)**(X.n_i1 + X.P + 1) * scalar_value( X.c0t_St1[i0,j0](u) @ X.caa1pXq_Tpq[i1,j1](u) )
    return result
...
def s01t01(X, i0s,i1s,j0s,j1s):
    ...
    for i0 in range(i0s):
        for i1 in range(i1s):
            for j0 in range(j0s):
                for j1 in range(j1s):
                    result[i0,i1,j0,j1] = 1 * scalar_value( X.cc0Xt_St1[i0,j0](p,u) @ X.aa1Xq_T0q[i1,j1](u,p) )
    return result
