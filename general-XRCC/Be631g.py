...
def _load_states(digit, n_states, states_location):
    states_file  = "atomic_states/H/16-115-550/{}/Z_{}e.npy".format(states_location, digit)
    configs_file = "atomic_states/data/configs_{}e-stable.npy".format(digit)
    data = None
...
class monomer_data(object):
    def __init__(self, displacement):
        ...
        self.basis.MOcoeffs = numpy.load("atomic_states/data/Be_C.npy")[:self.basis.n_spatial_orb,:self.basis.n_spatial_orb]	# top-left block because rest of code is for spin-restriced orbitals
