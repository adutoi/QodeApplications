...
h_mat       = numpy.load("data/Be_h.npy")
V_mat       = numpy.load("data/Be_V.npy")
C_scf_atom  = numpy.load("data/Be_C.npy")
C_scf_dimer = numpy.load("data/Be2_{}_C.npy".format(dist))
S_dimer     = numpy.load("data/Be2_{}_S.npy".format(dist))
print("Done.")
...
h_mat = numpy.load("data/Be2_{}_h.npy".format(dist))
V_mat = numpy.load("data/Be2_{}_V.npy".format(dist))
