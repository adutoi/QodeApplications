...
def compute_transform_matrix(C_Be_long, 
	...
	# numpy.save( "data/S_Be_Be2_{}.npy", S_Atomic_overlap)
...
def getBasisOverlapMatrix( C_scf_atom,     C_scf_dimer,  S_dimer, \
	...
	# numpy.save("data/S_Be_Be2_High.npy", S_Atomic_overlap_High)
	...
	# numpy.save("data/S_Be_Be2_Low.npy", S_Atomic_overlap_Low)
