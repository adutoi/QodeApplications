...
for charge, n_subset in [(+1, 5), (0, 5), (-1, 5)]:
    ...
    H = CI_space_atom.lin_op(field_op_ham.Hamiltonian(h,V, n_threads=n_threads, core=spin_core))
...
rho = densities.build_tensors(states, n_spin_orb, n_elec, core=spin_core)
