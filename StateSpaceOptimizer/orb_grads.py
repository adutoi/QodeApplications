...
def one_p_diagonal(dl, dr, dens, perm):  # 00
    ...
    #return 1 * XR_tensor.raw(dl(i0, i1) @ dens(i0, j0, 0, 1) @ delta(i1, i1) @ dr(j0, i1))
    int1 = evaluate(dl(0, i1) @ dr(1, i1))  # i0, j0
    #return 1 * XR_tensor.raw(dl(i0, i1) @ dens(i0, j0, 0, 1) @ dr(j0, i1))
    return 1 * XR_tensor.raw(int1(i0, j0) @ dens(i0, j0, 0, 1))

#def one_p_diagonal_11(dl, dr, dens, perm):  # 11
    #return 1 * scalar_value( X.ca0[i0,j0](p,q) @ X.t00(p,q) )
    #return 1 * XR_tensor.raw(dl(i0, i1) @ delta(i0, i0) @ dens(i1, j1, 0, 1) @ dr(i0, j1))
#    return 1 * XR_tensor.raw(dl(i0, i1) @ dens(i1, j1, 0, 1) @ dr(i0, j1))
...
def one_p_off_diagonal(dl, dr, dens0, dens1, n_i1, perm):  # 01
    ...
    #return (-1)**(n_i1 + perm) * XR_tensor.raw(dl(i0, i1) @ dens0(i0, j0, 0) @ dens1(i1, j1, 1) @ dr(j0, j1))
    return (-1)**(n_i1 + perm) * XR_tensor.raw(int1(0, i1, j1) @ dens1(i1, j1, 1))
...
def v0000_s(dl, dr, v_bior, v_halfbior1, v_halfbior2, s_inv_2, dens, perm, n_occ, sl0, sl1):
    ...
    #return 1 * scalar_value( X.ccaa0pqsr_Vpqrs[i0,j0] )
    #return 1 * scalar_value( X.ccaa0[i0,j0](p,q,s,r) @ X.v0000(p,q,r,s) )
    return -1 * XR_tensor.raw(s_inv_2[:,sl1](p, 1) @ v_halfbior2[sl0,:,:,:](0, q, r, s) @ int2(p, q, s, r)
                  + s_inv_2[:,sl1](q, 1) @ v_halfbior1[:,sl0,:,:](p, 0, r, s) @ int2(p, q, s, r))

#def v1111(dl, dr, v_bior, v_halfbior, s_inv_2, dens, perm):
#    return 2 * XR_tensor.raw(dl(i0, i1) @ v_bior(p, q, 1, s) @ dens(i1, j1, p, q, 0, s) @ dr(i0, j1)
...
def v0101(dl, dr, v_bior, v_halfbior1, v_halfbior2, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1):
    #return 4 * XR_tensor.raw( X.ca1(i1,j1,q,s) @ X.ca0pr_Vp1r1(i0,j0,q,s) )
    ...
    #return 4 * XR_tensor.raw(dl(i0, i1) @ v_bior[:,:,sl1,:](p, q, 1, s) @ dens0[:,:,:,sl0](i0, j0, p, 0) @ dens1(i1, j1, q, s) @ dr(j0, j1)
    #                 + dl(i0, i1) @ s_inv_2[:,sl0](p, 0) @ v_halfbior[sl1,:,:,:](1, q, r, s) @ dens0(i0, j0, p, r) @ dens1(i1, j1, q, s) @ dr(j0, j1))
    return 2 * XR_tensor.raw(2 * v_bior[:,:,sl1,:](p, q, 1, s) @ int4[:,:,:,sl0](q, s, p, 0)  # int2(q, s, p, 0)
...
def v1010(dl, dr, v_bior, v_halfbior1, v_halfbior2, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1):
    ...
    return -2 * XR_tensor.raw(#- v_bior[:,:,:,sl1](p, q, r, 1) @ int4[:,:,:,sl0](p, r, q, 0)
...
def v0010(dl, dr, v_bior, v_halfbior, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1):
    #return 2 * (-1)**(X.n_i1 + X.P) * XR_tensor.raw( X.a1(i1,j1,r) @ X.cca0pqs_Vpq1s(i0,j0,r) )
    ...
    #return 2 * (-1)**(n_i1 + perm) * XR_tensor.raw(
...
#def v0111(dl, dr, v_bior, v_halfbior, s_inv_2, dens0, dens1, n_i1, perm, n_occ):
    #return 2 * (-1)**(X.n_i1 + X.P) * XR_tensor.raw( X.c0(i0,j0,p) @ X.caa1qsr_V0qrs(i1,j1,p) )
...
#    return 2 * 2 * (-1)**(n_i1 + perm) * XR_tensor.raw(
...
#def v0011(dl, dr, v_bior, v_halfbior, s_inv_2, dens0, dens1, n_i1, perm, n_occ):
    #return 1 * XR_tensor.raw( X.aa1(i1,j1,s,r) @ X.cc0pq_Vpq11(i0,j0,r,s) )
...
#    return 2 * XR_tensor.raw(dl(i0, i1) @ v_bior[:,:,sl1,:](p, q, 1, s) @ dens0(i0, j0, p, q) @ dens1[:,:,:,sl0](i1, j1, s, 0) @ dr(j0, j1)
...
def v0011(dl, dr, v_bior, v_halfbior, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1):
    ...
    #return 2 * XR_tensor.raw(dl(i0, i1) @ s_inv_2[:,sl0](p, 0) @ v_halfbior[sl1,:,:,:](1, q, r, s) @ dens0(i0, j0, p, q) @ dens1(i1, j1, s, r) @ dr(j0, j1))
    return -2 * XR_tensor.raw(s_inv_2[:,sl1](p, 1) @ v_halfbior[sl0,:,:,:](0, q, r, s) @ int2(s, r, p, q))
...
def v1100(dl, dr, v_bior, v_halfbior, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1):
    ...
    # for this term to have fragment 0 as target index the permutation (frag0<-->frag1) needs to be applied
    #return 2 * XR_tensor.raw(dl(i0, i1) @ v_bior[:,:,sl1,:](p, q, 1, s) @ dens1(i1, j1, p, q) @ dens0[:,:,:,sl0](i0, j0, s, 0) @ dr(j0, j1))
    return 2 * XR_tensor.raw(v_bior[:,:,sl1,:](p, q, 1, s) @ int2(s, 0, p, q))
...
def v0000_hess(dl, dr, v_bior, v_halfbior1, v_halfbior2, v_symm, s_inv_2, dens, perm, n_occ, sl0, sl1, sl2, sl3):
    ...
    #return 2 * XR_tensor.raw(dl(i0, i1) @ v_bior[:,:,sl1,sl3](p, q, 1, 3) @ dens[:,:,:,:,sl0,sl2](i0, j0, p, q, 0, 2) @ dr(j0, i1)
    ...
    return 1 * XR_tensor.raw(v_bior[:,:,sl1,sl3](p, q, 1, 3) @ int2[:,:,sl0,sl2](p, q, 2, 0)
...
def v0101_hess(dl, dr, v_bior, v_halfbior1, v_halfbior2, v_symm, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1, sl2, sl3):
    ...
    #return 4 * XR_tensor.raw(dl(i0, i1) @ s_inv_2[:,sl0](p, 0) @ v_halfbior[sl1,:,sl3,:](1, q, 3, s) @ dens0[:,:,:,sl2](i0, j0, p, 2) @ dens1(i1, j1, q, s) @ dr(j0, j1))
    return -2 * XR_tensor.raw(s_inv_2[:,sl1](p, 1) @ dens0[:,:,:,sl2](i0, j0, p, 2) @ int2(i0, j0, 0, 3))
...
def v1010_hess(dl, dr, v_bior, v_halfbior1, v_halfbior2, v_symm, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1, sl2, sl3):
    ...
    int2 = evaluate(dl(0, i1) @ dr(1, j1) @ int1(2, 3, i1, j1))  # i0, j0, 1, 3
    #return 4 * XR_tensor.raw(dl(i0, i1) @ s_inv_2[:,sl0](p, 0) @ v_halfbior[sl1,:,sl3,:](1, q, 3, s) @ dens0[:,:,:,sl2](i0, j0, p, 2) @ dens1(i1, j1, q, s) @ dr(j0, j1))
    return -2 * XR_tensor.raw(s_inv_2[:,sl1](q, 1) @ dens0[:,:,:,sl2](i0, j0, q, 2) @ int2(i0, j0, 0, 3))
...
def v0011_hess(dl, dr, v_bior, v_halfbior, v_symm, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1, sl2, sl3):
    ...
    int2 = evaluate(dl(0, i1) @ dr(1, j1) @ int1(2, 3, i1, j1))  # i0, j0, 1, 3
    #return 2 * XR_tensor.raw(dl(i0, i1) @ s_inv_2[:,sl0](p, 0) @ s_inv_2[:,sl2](q, 2) @ v_symm[sl1,sl3,:,:](1, 3, r, s) @ dens0(i0, j0, p, q) @ dens1(i1, j1, s, r) @ dr(j0, j1))
    return 2 * XR_tensor.raw(s_inv_2[:,sl1](p, 1) @ s_inv_2[:,sl3](q, 3) @ dens0(i0, j0, p, q) @ int2(i0, j0, 0, 2))
...
def v1100_hess(dl, dr, v_bior, v_halfbior, v_symm, s_inv_2, dens0, dens1, n_i1, perm, n_occ, sl0, sl1, sl2, sl3):
    ...
    # for this term to have fragment 0 as target index the permutation (frag0<-->frag1) needs to be applied
    #return 2 * XR_tensor.raw(dl(i0, i1) @ v_bior[:,:,sl1,sl3](p, q, 1, 3) @ dens1(i1, j1, p, q) @ dens0[:,:,sl2,sl0](i0, j0, 2, 0) @ dr(j0, j1))
    return 2 * XR_tensor.raw(dl(i0, i1) @ int1(1, 3, i1, j1) @ dens0[:,:,sl2,sl0](i0, j0, 2, 0) @ dr(j0, j1))
"""
#####################################
# 2p density
#####################################
...
def two_p_0000(dl, dr, dens, perm):
    int1 = evaluate(dl(0, i1) @ dr(1, i1))  # i0, j0
    return 1 * XR_tensor.raw(dens(i0, j0, 0, 1, 3, 2) @ int1(i0, j0))  # p,q,r,s

def two_p_0101(dl, dr, dens0, dens1, n_i1, perm):
    int1 = evaluate(dl(0, i1) @ dens1(i1, j1, 2, 3) @ dr(1, j1))  # i0, j0, q, s
    return 1 * XR_tensor.raw(int1(i0, j0, 1, 3) @ dens0(i0, j0, 0, 2))  # p,q,r,s

def two_p_0010(dl, dr, dens0, dens1, n_i1, perm):
    int1 = evaluate(dl(0, i1) @ dens1(i1, j1, 2) @ dr(1, j1))  # i0, j0, r
    return 1 * (-1)**(n_i1 + perm) * XR_tensor.raw(dens0(i0, j0, 0, 1, 3) @ int1(i0, j0, 2))  # p,q,r,s

def two_p_0111(dl, dr, dens0, dens1, n_i1, perm):
    int1 = evaluate(dl(i0, 0) @ dens0(i0, j0, 2) @ dr(j0, 1))  # i1, j1, p
    return 1 * (-1)**(n_i1 + perm) * XR_tensor.raw(int1(i1, j1, 0) @ dens1(i1, j1, 1, 3, 2))

def two_p_0011(dl, dr, dens0, dens1, n_i1, perm):
    int1 = evaluate(dl(i0, 0) @ dens0(i0, j0, 2, 3) @ dr(j0, 1))  # i1, j1, p, q
    return 1 * XR_tensor.raw(int1(i1, j1, 0, 1) @ dens1(i1, j1, 3, 2))


one_p_dens_catalog = {
    # (frag0, frag1): [Dchgs, dens_types, diagram]
    (0, 0): [(0, 0), ["ca"], one_p_diagonal],
    (0, 1): [(-1, +1), ["c", "a"], one_p_off_diagonal]
}

two_p_dens_catalog = {
    # (frag0, frag1): [Dchgs, dens_types, diagram, transpose]
    (0, 0, 0, 0): [(0, 0), ["ccaa"], two_p_0000, (0,1,2,3)],
    (0, 1, 0, 1): [(0, 0), ["ca", "ca"], two_p_0101, (0,1,2,3)],  # with excepting this term from the fragment index swap, one can build all 4 terms with the transpose
    (0, 1, 1, 0): [(0, 0), ["ca", "ca"], two_p_0101, (0,1,3,2)],
    (0, 0, 1, 0): [(-1, +1), ["cca", "a"], two_p_0010, (0,1,2,3)],
    (0, 0, 0, 1): [(-1, +1), ["cca", "a"], two_p_0010, (0,1,3,2)],  # TODO: this requires caching
    (0, 1, 1, 1): [(-1, +1), ["c", "caa"], two_p_0111, (0,1,2,3)],
    (1, 0, 1, 1): [(-1, +1), ["c", "caa"], two_p_0111, (1,0,2,3)],
    (0, 0, 1, 1): [(-2, +2), ["cc", "aa"], two_p_0011, (0,1,2,3)]
}
            ...
            for s2 in range(2):
                for j in range(2):
                    ...
                    ret[mat_ov_slice[(j, pl, s1)], mat_ov_slice[(j, ql, s2)]] +=\
                        comb[0] * XR_tensor.raw(s_symm(j, i)[ov_slice[(j, pl, s1)], :](0, r) @ h_dens[mat_ov_slice[(j, ql, s2)], mat_slice[i]](1, r))
                    ret[mat_ov_slice[(i, pl, s1)], mat_ov_slice[(i, ql, s2)]] +=\
                        comb[0] * XR_tensor.raw(s_symm(j, i)[:, ov_slice[(i, ql, s2)]](r, 1) @ h_dens[mat_slice[j], mat_ov_slice[(i, pl, s1)]](r, 0))
        ...
        for s1 in range(2):
            for s2 in range(2):
                for i in range(2):
                    for j in range(2):
                        for l in range(2):
                            if not off_diag_blocks and l != j:
                                continue
                            ret[mat_ov_slice[(j, pl, s1)], mat_ov_slice[(l, ql, s2)]] +=\
                                comb[0] * XR_tensor.raw(t_bior(i, l)[:, ov_slice[(l, ql, s2)]](r, 1) @ h_dens[mat_slice[i], mat_ov_slice[(j, pl, s1)]](r, 0))
                                            #- t_bior(j, i)[ov_slice[(j, pl, s1)],:](0, r) @ h_dens[mat_ov_slice[(l, ql, s2)], mat_slice[i]](1, r))
                            
def t_diagram2(ret, h_dens, ints_bior, ov_slice, mat_ov_slice, mat_slice, off_diag_blocks=True):
    combs = [(1, [x, y]) for x in ["a", "i"] for y in ["a", "i"]]
    def t_bior(i, j):
        return ints_bior.T[i,j]
    for comb in combs:
                    ...
                    for j in range(2):
                        for l in range(2):
                            if not off_diag_blocks and l != j:
                                continue
                            ret[mat_ov_slice[(j, pl, s1)], mat_ov_slice[(l, ql, s2)]] -=\
                                comb[0] * XR_tensor.raw(t_bior(j, i)[ov_slice[(j, pl, s1)],:](0, r) @ h_dens[mat_ov_slice[(l, ql, s2)], mat_slice[i]](1, r))
    ...
    for k in range(2):
        for l in range(2):
            ...
            ret[mat_slice[k], mat_slice[l], mat_slice[k], mat_slice[l]] -=\
                1 * XR_tensor.raw(t_bior(k, l)[:,:](2, 1) @ h_dens[mat_slice[l], mat_slice[k]](3, 0))
        """
        for comb in combs:
            macrocomb = [comb[1]]
                ...
                for s1 in range(2):
                    for s2 in range(2):
                        ...
                        ret[mat_ov_slice[(k, pl, s1)], mat_ov_slice[(k, ql, s2)], mat_ov_slice[(k, pr, s3)], mat_ov_slice[(k, qr, s4)]] -=\
                            comb[0] * XR_tensor.raw(t_bior(k, k)[ov_slice[(k, pr, s3)], ov_slice[(k, ql, s2)]](2, 1) @ h_dens[mat_ov_slice[(k, qr, s4)], mat_ov_slice[(k, pl, s1)]](3, 0))
        """
        """
        ...
        for i in range(*ov_slice_range[(k, "i")]):
            ...
            for a in range(*ov_slice_range[(k, "a")]):
                ...
                ret[a_, i_] +=\
                    XR_tensor.raw(t_symm(k, k)[i, i] * s_inv_2(j, k)[:, a](r) @ h_dens[mat_slice[j], a_](r))
        """


def u_diagram(ret, h_dens, ints_bior, ov_slice, mat_ov_slice, mat_slice, off_diag_blocks=True):
    combs = [(1, [x, y]) for x in ["a", "i"] for y in ["a", "i"]]
    def u_bior(n, i, j):
                        ...
                        for j in range(2):
                            for l in range(2):
                                if not off_diag_blocks and l != j:
                                    continue
                                ret[mat_ov_slice[(j, pl, s1)], mat_ov_slice[(l, ql, s2)]] +=\
                                    comb[0] * XR_tensor.raw(u_bior(n, i, l)[:, ov_slice[(l, ql, s2)]](r, 1) @ h_dens[mat_slice[i], mat_ov_slice[(j, pl, s1)]](r, 0))
                                                #- u_bior(n, j, i)[ov_slice[(j, pl, s1)],:](0, r) @ h_dens[mat_ov_slice[(l, ql, s2)], mat_slice[i]](1, r))
                                
def u_diagram2(ret, h_dens, ints_bior, ov_slice, mat_ov_slice, mat_slice, off_diag_blocks=True):
    combs = [(1, [x, y]) for x in ["a", "i"] for y in ["a", "i"]]
    def u_bior(n, i, j):
        return ints_bior.U[n,i,j]
    for comb in combs:
                        ...
                        for j in range(2):
                            for l in range(2):
                                if not off_diag_blocks and l != j:
                                    continue
                                ret[mat_ov_slice[(j, pl, s1)], mat_ov_slice[(l, ql, s2)]] -=\
                                    comb[0] * XR_tensor.raw(u_bior(n, j, i)[ov_slice[(j, pl, s1)],:](0, r) @ h_dens[mat_ov_slice[(l, ql, s2)], mat_slice[i]](1, r))                                
        ...
        for k in range(2):
            for l in range(2):
                if not off_diag_blocks and l != k:
                    continue
                ret[mat_slice[k], mat_slice[l], mat_slice[k], mat_slice[l]] -=\
                    1 * XR_tensor.raw(u_bior(n, k, l)[:,:](2, 1) @ h_dens[mat_slice[l], mat_slice[k]](3, 0))
            """
            for comb in combs:
                macrocomb = [comb]
                #if comb[1][0] == comb[1][1]:
                ...
                for mac in macrocomb:
                    ...
                    for s1 in range(2):
                        for s2 in range(2):
                            ...
                            s4 = s2
                            ret[mat_ov_slice[(k, pl, s1)], mat_ov_slice[(k, ql, s2)], mat_ov_slice[(k, pr, s3)], mat_ov_slice[(k, qr, s4)]] -=\
                                comb[0] * XR_tensor.raw(u_bior(n, k, k)[ov_slice[(k, pr, s3)], ov_slice[(k, ql, s2)]](2, 1) @ h_dens[mat_ov_slice[(k, qr, s4)], mat_ov_slice[(k, pl, s1)]](3, 0))
            """
"""
def v_diagram_without_2p_dens(ret, dl_, dr_, dens, ints_bior, ints_symm, s_inv_2_, d_slices, n_occ, mat_ov_slice, ov_slice):
    ...
    for instruction in v_catalog:
        ...
        for target_frag in range(2):
            ...
            if perm:
                dl = XR_tensor.init(dl_.T)
                dr = XR_tensor.init(dr_.T)
                int_frags = [1 - int(i) for i in int_diag[1:]]
            else:
                dl = XR_tensor.init(dl_)
                dr = XR_tensor.init(dr_)
            ...
            if len(field_ops) == 1:
                ...
                for chg in d_slices[i]:
                    #for frag, op in enumerate(field_ops):
                        #if op == "delta":
                        #    delta = XR_tensor.init(tl.eye(n_occ[frag] + n_virt[frag]))
                        #else:
...
def v_diagram(ret, v_dens, ints_bior, ov_slice, mat_ov_slice, mat_slice, off_diag_blocks=True):
    combs = [(1, [x, y]) for x in ["a", "i"] for y in ["a", "i"]]
    def v_bior(i, j, k, l):
                    ...
                    for j in range(2):
                        for k in range(2):
                            for l in range(2):
                                ...
                                for m in range(2):
                                    if not off_diag_blocks and m != l:
                                        continue
                                    ret[mat_ov_slice[(l, pl, s1)], mat_ov_slice[(m, ql, s2)]] +=\
                                        comb[0] * 1 * XR_tensor.raw(v_bior(i, j, k, m)[:,:,:,ov_slice[(m, ql, s2)]](p, q, r, 1)
...
def v_diagram2(ret, v_dens, ints_bior, ov_slice, mat_ov_slice, mat_slice, off_diag_blocks=True):
    combs = [(1, [x, y]) for x in ["a", "i"] for y in ["a", "i"]]
    def v_bior(i, j, k, l):
        return ints_bior.V[i,j,k,l]
    for comb in combs:
                            ...
                            for l in range(2):
                                ...
                                for m in range(2):
                                    if not off_diag_blocks and m != l:
                                        continue
                                    ret[mat_ov_slice[(l, pl, s1)], mat_ov_slice[(m, ql, s2)]] -=\
                                        comb[0] * 1 * XR_tensor.raw(v_bior(l, i, j, k)[ov_slice[(l, pl, s1)],:,:,:](0, q, r, s)
                                                        @ v_dens[mat_ov_slice[(m, ql, s2)],mat_slice[i],mat_slice[j],mat_slice[k]](1, q, r, s)
                                                        + v_bior(i, l, j, k)[:,ov_slice[(l, pl, s1)],:,:](p, 0, r, s)
                                                        @ v_dens[mat_slice[i],mat_ov_slice[(m, ql, s2)],mat_slice[j],mat_slice[k]](p, 1, r, s))
            ...
            for k in range(2):
                for m in range(2):
                    ...
                    ret[mat_slice[k], mat_slice[m], mat_slice[k], mat_slice[m]] +=\
                        1 * XR_tensor.raw(v_bior(i, j, m, m)[:,:,:,:](p, q, 1, 3)
                            ...
                            for k in range(2):
                                ...
                                for m in range(2):
                                    ...
                                    ret[mat_ov_slice[(k, pl, s1)], mat_ov_slice[(m, ql, s2)], mat_ov_slice[(k, pr, s3)], mat_ov_slice[(m, qr, s4)]] +=\
                                        comb[0] * XR_tensor.raw(v_bior(i, j, m, m)[:,:,ov_slice[(m, ql, s2)],ov_slice[(m, qr, s4)]](p, q, 1, 3)
...
class grads_and_hessian(object):
        ...
        for key in one_p_dens_catalog:
            ...
            for perm in range(2):
                ...
                if i == j:
                    ...
                    continue
                # do dimer stuff
                for bra_chgi in self.d_slices[0 + perm]:
                    for ket_chgi in self.d_slices[0 + perm]:
                        if bra_chgi - ket_chgi != Dchgs[0]:
                            continue
                        for bra_chgj in self.d_slices[1 - perm]:
                            for ket_chgj in self.d_slices[1 - perm]:
                                if bra_chgj - ket_chgj != Dchgs[1]:
                                    continue
                                n_i1 = get_prefactor_exponent([sum(self.n_occ), sum(self.n_occ)], [(bra_chgi, ket_chgi), (bra_chgj, ket_chgj)])
                                densi = dens[0 + perm][field_ops[0]][(bra_chgi, ket_chgi)]
                                densj = dens[1 - perm][field_ops[1]][(bra_chgj, ket_chgj)]
    ...
    def two_p_dens(self, mat, dl_, dr_, dens):
        ...
        for key in two_p_dens_catalog:
            Dchgs, field_ops, diagram, transpose = two_p_dens_catalog[key]
            if transpose == (0,1,2,3):
                pref = 1
            else:  # currently no sophisticated measure needs to be applied
                pref = -1
            for perm in range(2):
                i, j, k, l = key
                if perm:
                ...
                if len(field_ops) == 1:
                    ...
                    for chg in self.d_slices[i]:
                        dens0 = dens[i][field_ops[0]][(chg, chg)]
                        mat[self.mat_slice[i], self.mat_slice[i], self.mat_slice[i], self.mat_slice[i]] += pref * np.transpose(diagram(dl[self.d_slices[i][chg], :],
                                                                                                                   dr[self.d_slices[i][chg], :],
                                                                                                                   dens0, perm), transpose)
                    continue
                # do dimer stuff
                    ...
                    for ket_chg0 in self.d_slices[0 + perm]:
                        ...
                        for bra_chg1 in self.d_slices[1 - perm]:
                            for ket_chg1 in self.d_slices[1 - perm]:
                                ...
                                dens0 = dens[0 + perm][field_ops[0]][(bra_chg0, ket_chg0)]
                                dens1 = dens[1 - perm][field_ops[1]][(bra_chg1, ket_chg1)]
                                mat[self.mat_slice[i], self.mat_slice[j], self.mat_slice[k], self.mat_slice[l]] += pref * np.transpose(diagram(
    ...
    def build_s_inv_2(self, zero, S):  # build ints_symm.S ** (-2)
        for i in range(2):
            for j in range(2):
                zero[self.mat_slice[i], self.mat_slice[j]] = XR_tensor.raw(S[i, j])
        s_inv = precise_numpy_inverse(zero)  # this only works if s is actually close to the identity
        s_inv_2_raw = s_inv @ s_inv
        return {(i, j): XR_tensor.init(s_inv_2_raw[self.mat_slice[i], self.mat_slice[j]]) for i in range(2) for j in range(2)}
    ...
    def orb_grads(self, dl, dr, dens, ints, off_diag=True):
        ...
        print("computing t")
        t_diagram(grad, h_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        t_diagram2(grad, h_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        print("computing u")
        u_diagram(grad, h_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        u_diagram2(grad, h_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        ...
        v_diagram(grad, v_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        v_diagram2(grad, v_dens, ints_bior, self.ov_slice, self.mat_ov_slice, self.mat_slice, off_diag_blocks=off_diag)  # update mat in place
        print("done")
